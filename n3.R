...
# Define a list of hidden layer structures
hidden_layer_structures <- list(c(1, 1), c(1, 2), c(1, 3),
                                c(1, 4), c(1, 5), c(1, 6),
                                c(1, 8), c(1, 9), c(1, 10),
                                c(2, 1), c(2, 5), c(2, 6),
                                c(2, 7), c(2, 8), c(3, 1),
                                ...
                                c(8, 2), c(8, 6), c(8, 7),
                                c(8, 9), c(8, 10), c(9, 2),
                                c(10, 1), c(10, 5), c(10, 8))  # Add more structures as needed
...
for (i in 1:length(io_matrices)) {
  ...
  for (activation in c("logistic", "tanh")) {
    for (structure in hidden_layer_structures) {
      ...
      model_name <- paste(lag_options[i], paste(structure, collapse = "_"), activation, sep = "_")
...
for (model_name in names(models)) {
  if (models[[model_name]]$mape < 0.3418748) {
    cat("Model Name:", model_name, "\n")
    cat("RMSE:", models[[model_name]]$rmse, "\n")
    cat("MAE:", models[[model_name]]$mae, "\n")
    cat("MAPE:", models[[model_name]]$mape, "\n")
